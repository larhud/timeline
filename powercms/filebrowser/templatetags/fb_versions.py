...
# FILEBROWSER IMPORTS
from powercms.filebrowser.settings import VERSIONS, PLACEHOLDER, SHOW_PLACEHOLDER, FORCE_PLACEHOLDER
from powercms.filebrowser.base import FileObject
from powercms.filebrowser.sites import get_default_site
register = Library()
