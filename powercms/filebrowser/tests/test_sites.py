...
from powercms.filebrowser.settings import DIRECTORY, VERSIONS
from powercms.filebrowser.base import FileObject
from powercms.filebrowser.sites import get_site_dict
...
def test_convert_normalize(test):
    ...
    path = os.path.join(test.tmpdir.path, 'TEST IMAGE 000_1.jpg')
    test.assertTrue(test.site.storage.exists(path))
    test.assertEqual(sorted(test.site.storage.listdir(test.tmpdir)[1]), ['TEST IMAGE 000.jpg', 'TEST IMAGE 000_1.jpg', u'testimage.jpg', u'testimage_1.jpg'])
