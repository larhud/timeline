...
from powercms.filebrowser.settings import EXTENSIONS, VERSIONS, ADMIN_VERSIONS, VERSIONS_BASEDIR, VERSION_QUALITY, IMAGE_MAXBLOCK
from powercms.filebrowser.utils import path_strip, scale_and_crop
...
class FileListing():
    ...
    An example::
        ...
        from powercms.filebrowser.base import FileListing
    ...
    def __init__(self, path, filter_func=None, sorting_by=None, sorting_order=None, site=None):
        ...
        if not site:
            from powercms.filebrowser.sites import site as default_site
            site = default_site
        self.site = site
...
class FileObject:
    ...
    An example::
        ...
        from powercms.filebrowser.base import FileObject
    ...
    def date(self):
        ...
        if self.exists:
            ...
            try:
                self._date_stored = os.path.getmtime(self.path_full)
            except FileNotFoundError:
                self._date_stored = self.gettime_modificated
            return self._date_stored
        return None
    ...
    @property
    def gettime_modificated(self):
        return self.site.storage.get_modified_time(self.path)
